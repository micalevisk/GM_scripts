            ...
            modules = [
                ...
                },
                {
                    ...
                    loadStart: function () {
                        ...
                        if (!user_settings.player_auto_play && window.movie_player) { // FIXING autoplay
                ...
                },
                {
                    options: {
                        player_quick_controls: {
                            ...
                            i18n: {
                                ...
                                button_save_time_player: "Save Current Time",
                    ...
                    quickControls: function (event) {
                        ...
                        switch (event.target.id) {
                            ...
                            case "iri-quick-control-save-time-player":
                                this.quickControlSaveTime();
                                break;
                        ...
                        if (user_settings.player_quick_controls && document.querySelector("ytd-watch:not([hidden]), ytd-watch-flexy:not([hidden])") && (meta_section = document.querySelector("#menu-container"))) {
                            ...
                            if (!controls) {
                                ...
                                controls.innerHTML =
                                    ...
                                    "        </button>" +
                                    "        <button id='iri-quick-control-save-time-player'>" +
                                    ...
                                    "            </svg>" +
                                    "            <div class='iri-quick-controls-tooltip' data-locale='text|button_save_time_player'></div>" +
                                    "        </button>" +
                                    "    </div>" +
                                    "</div>";
